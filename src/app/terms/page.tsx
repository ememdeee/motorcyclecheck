        ...
        >
          <section>
            ...
            <p className="text-gray-300 mb-8">
              Welcome to MotoInsights.com! The representations of our services and products available through this website do not constitute a binding offer. By clicking &apos;SEARCH&apos; or &apos;SHOW ME MY REPORT&apos; or &apos;YES, CONTINUE TO MY REPORT,&apos; You agree to be bound to these Terms of Use (the &apos;Agreement&apos;), constituting a legally binding agreement by and between MotoInsights, (hereinafter, &apos;MotoInsights&apos; or &apos;We&apos; or &apos;Our&apos;) and you (in either case, &apos;You&apos; or &apos;Your&apos;) concerning Your use of MotoInsights website (the &apos;Website&apos;) and the services available through the Website (the &apos;Services&apos;).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              Internet technology and the applicable laws, rules, and regulations change frequently. Accordingly, MotoInsights reserves the right to change this agreement and its privacy policy at any time upon notice to you, to be given by the posting of a new version or a change notice on the website.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              Without limitation, you agree that MotoInsights is merely a technology solution that serves as a third-party platform and you use the Website and Services at Your own risk, without limitation and pursuant to Section: ASSUMPTION OF RISK; RELEASE.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              Unless otherwise stated, MotoInsights owns the intellectual property rights for all material on https://www.motoinsights.com/. All intellectual property rights are reserved. You may view and/or print pages from https://www.motoinsights.com/ for your own personal use subject to restrictions set in these terms and conditions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              The information on the Website is provided for information purposes only. The Website and Services are provided only as a technology solution and MotoInsights shall not be liable for any delay or failure to make available the Report.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              You knowingly and freely assume all risk when using the website and services. You, on behalf of yourself, your personal representatives, and your heirs, hereby voluntarily agree to release, waive, discharge, hold harmless, defend, and indemnify MotoInsights and its stockholders, officers, directors, employees, agents, affiliates, consultants, representatives, sublicenses, successors, and assigns from any and all claims, actions, or losses for bodily injury, property damage, wrongful death, emotional distress, loss of privacy, or other damages or harm, whether to you or to third parties, that may result from your use of the website and services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              You acknowledge and agree that MotoInsights reserves the right to charge for access to the Website and use of the Services, in accordance with the Fees that are clearly disclosed throughout the Website.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              The Website is linked with the websites of third parties (&apos;Third-Party Websites&apos;), some of whom may have established relationships with MotoInsights and some of whom may not. MotoInsights does not have control over the content and performance of Third-Party Websites.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              MotoInsights imposes certain restrictions on your use of the Website and the Services. You represent and warrant that you will not engage in any prohibited activities, including but not limited to: stalking, harassing, impersonating others, or collecting information about users without their consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              This site is provided by MotoInsights on an &apos;as is&apos; and &apos;as available&apos; basis. MotoInsights does not specifically warrant or guarantee the accuracy of its search reports. MotoInsights makes no representations or warranties regarding any liens or security interests filed after the date and time indicated on the report.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              You represent and warrant that your use of the Website and Services will be in accordance with this Agreement and any other MotoInsights policies, and with any applicable laws or regulations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              Without limiting any indemnification provision of this Agreement, You (the &apos;Indemnitor&apos;) agree to defend, indemnify and hold harmless MotoInsights and the Parties (collectively, the &apos;Indemnities&apos;) from and against any and all claims, actions, demands, causes of action, and other proceedings (collectively, &apos;Claims&apos;), including but not limited to legal costs and fees.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              All notices required or permitted to be given under this Agreement must be in writing. MotoInsights shall give any notice by email sent to the most recent email address, if any, provided by the intended recipient to MotoInsights. You agree that any notice received from MotoInsights electronically satisfies any legal requirement that such notice be in writing.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-8">
              This Agreement constitutes the entire agreement between MotoInsights and You concerning your use of the Website and Services. This Agreement may only be modified by a written amendment signed by an authorized executive of MotoInsights or by the unilateral amendment of this Agreement by MotoInsights and by the posting by MotoInsights of such amended version. A waiver by either party of any term or condition of this Agreement or any breach thereof, in any one instance, will not waive such term or condition or any subsequent breach thereof.
            </p>
          </section>
        </motion.div>
